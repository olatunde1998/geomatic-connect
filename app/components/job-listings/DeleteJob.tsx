...
export default function DeleteJob({
  ...
  return (
    <div className="bg-white dark:bg-background p-8 rounded-[0.63rem]  mx-auto">
      ...
      <div className="mt-12 flex space-x-4">
        <div
          className="border-[1.5px] border-slate-300 dark:border-muted dark:text-muted-foreground rounded-[8px] px-[28px] py-[12px] cursor-pointer text-center w-full lg:w-[230px]"
